...
public class TestAPIMark {

    private static final String BASE_URL = "http://localhost:8080/VenteVelos-1.0-SNAPSHOT";
    ...
    @Test
    @Order(1)
    public void testAddMarksEndpoint() throws Exception {
        String endpoint = "/api/v1/marques";
        String requestBody = "{\n" +
                "  \"id\": 1000,\n" +
                "  \"nom\": \"Haro\"\n" +
                "}";
        ...
        assertTrue(responseBody.contains("Haro was created successfully."));

    }

    @Test
    @Order(2)
    public void testGetMarksEndpoint() throws Exception {
        HttpClient httpClient = HttpClients.createDefault();
        HttpGet request = new HttpGet(BASE_URL + "/api/v1/marques"); // Spécifiez l'URL de l'endpoint à tester
        ...
        assertTrue(responseBody.contains("\"nom\":\"Haro\""));

    }

    @Test
    @Order(3)
    public void testGetMarkByIdEndpoint() throws Exception {
        String endpoint = "/api/v1/marques"; // The API endpoint
    ...
    @Test
    @Order(4)
    public void testDeleteMarkByIdEndpoint() throws Exception {
        String endpoint = "/api/v1/marques/1000";
        ...
        assertTrue(responseBody.contains("Haro was deleted successfully."));
