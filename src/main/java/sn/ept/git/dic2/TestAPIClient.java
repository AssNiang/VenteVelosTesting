...
public class TestAPIClient {
    ...
    @Test
    @Order(1)
    public void testAddClientsEndpoint() throws Exception {
        ...
        assertTrue(responseBody.contains("Ass Malick was created successfully."));

    }

    @Test
    @Order(2)
    public void testGetClientsEndpoint() throws Exception {
        HttpClient httpClient = HttpClients.createDefault();
        HttpGet request = new HttpGet(BASE_URL + "/api/v1/clients"); // Spécifiez l'URL de l'endpoint à tester
    ...
    @Test
    @Order(3)
    public void testGetClientByIdEndpoint() throws Exception {
        String endpoint = "/api/v1/clients"; // The API endpoint
    ...
    @Test
    @Order(4)
    public void testDeleteClientByIdEndpoint() throws Exception {
        String endpoint = "/api/v1/clients/1000";
        ...
        assertTrue(responseBody.contains("Ass Malick was deleted successfully."));
