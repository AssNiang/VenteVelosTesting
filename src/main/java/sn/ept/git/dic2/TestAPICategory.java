...
public class TestAPICategory {
    ...
    @Test
    @Order(1)
    public void testAddCategorysEndpoint() throws Exception {
        ...
        assertTrue(responseBody.contains("Children Bicycles was created successfully."));
    ...
    public void testGetCategoriesEndpoint() throws Exception {
        HttpClient httpClient = HttpClients.createDefault();
        HttpGet request = new HttpGet(BASE_URL + "/api/v1/categories"); // Spécifiez l'URL de l'endpoint à tester
        ...
        assertTrue(responseBody.contains("\"nom\":\"Children Bicycles\""));
    ...
    public void testGetCategoryByIdEndpoint() throws Exception {
        String endpoint = "/api/v1/categories"; // The API endpoint
    ...
    @Test
    @Order(4)
    public void testPutCategoryEndpoint() throws Exception {
        String endpoint = "/api/v1/categories";
        String requestBody = "{\n" +
                "  \"id\": 1000,\n" +
                "  \"nom\": \"Adult Bicycles\"\n" +
        ...
        // Check if the response contains a success message
        assertTrue(responseBody.contains("Children Bicycles was edited successfully."));
    ...
    @Test
    @Order(5)
    public void testDeleteCategoryByIdEndpoint() throws Exception {
        String endpoint = "/api/v1/categories/1000";
        ...
        assertEquals(200, statusCode);
        assertTrue(responseBody.contains("Adult Bicycles was deleted successfully."));
